...
def main() -> int:
    ...
    if len(executable) != 17:
        fail(f"comparison inventory expects 17 executable hooks, found {len(executable)}")
    ...
    for marker in ("## Findings", "## Disagreements", "## Not adopted", "## Sources", "14 skills", "17 executable event hooks"):
    ...
    print("OK: 14 skills and 17 executable hooks have local contracts")
