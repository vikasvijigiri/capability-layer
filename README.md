...
| `tools/` | `run_checks.py`, `resume.py`, `loop.py`, `recon.py`, `parallel_groups.py`, `scope.py`, `worktree.py`, `security_gate.py`, `bench.py`, and the 49 suites that keep all of it honest |
