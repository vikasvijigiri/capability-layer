...
- **Do not repair what you find.** A recon that fixes three things has an
  unreviewed diff and no map. `systematic-debugging` owns a real failure;
  `no-slop` owns cleanup.
