...
- A REVISE verdict returns a spec to `brainstormer` or a plan to
  `writing-plans`; it must not jump directly to implementation.

## Routing

- Entered after `brainstormer` produces a spec or after `writing-plans` drafts
